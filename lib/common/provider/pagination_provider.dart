...
T extends IModelWithId, U extends IBasePaginationRepository<T>> extends StateNotifier<CursorPaginationBase> {
  final U repository;
  ...
  Future<void> paginate({
    ...
    try {
      ...
      if (fetchMore) {
        // 데이터를 추가 조회
        final pState = state as CursorPagination<T>; // 설계상 fetchMore = true -> 기존에 이미 데이터 들고있는 상태!!!
